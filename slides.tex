...
\begin{frame}
    ...
    \begin{columns}[onlytextwidth,t]
       ...
       \begin{figure}
            ...
            \only<4>{\includegraphics[width=0.75\textwidth]{images/components.eps}
            ...
            \only<5>{\includegraphics[width=0.9\textwidth]{images/correlation_2.png}
                % \caption{\scriptsize\itshape Figure from T. Lappi \href{https://arxiv.org/abs/hep-ph/0602189}{{\color{lightgray}\textit{[hep-ph/0602189]}}}}
            }
            \only<6>{\includegraphics[width=0.9\textwidth]{images/anisotropy.png}
            % \caption{\scriptsize\itshape Figure from T. Lappi \href{https://arxiv.org/abs/hep-ph/0602189}{{\color{lightgray}\textit{[hep-ph/0602189]}}}}
        }
        ...
        \begin{center}
            \begin{itemize}
                \onslide<1,2,3,4,5,6>{\item Relevant scale {\color{custompink}saturation momentum $Q_s$}}
                \onslide<2,3,4,5,6>{\item Initial longitudinal color flux tubes}
                \onslide<3,4,5,6>{\item Fields {\color{customgreen}dilute} after $\tau\simeq {\color{custompink}Q}^{-1}_{\color{custompink}s}$}
                \onslide<5,6>{\item Fields arranged in {\color{customgreen}correlation domains} of $\delta x_T \simeq {\color{custompink}Q}^{-1}_{\color{custompink}s}$}
                \onslide<6>{\item Longitudinal $\neq$ transverse pressures $\Rightarrow$ {\color{pinky}anisotropy}}
            \end{itemize}
        \end{center}
        \column{.02\textwidth}
    \end{columns}
