...
\begin{frame}
    \frametitle{Particles in Yang-Mills fields}
        \begin{itemize}
            ...
            \item  {\large{{\color{pinky}Quantities}: averaged over particle trajectories and glasma events}}
                ...
                \begin{itemize}
                    ...
                    \item[\raisebox{0.2em}{\scalebox{0.6}{${\color{ming}\blacktriangleright}$}}] \tikzmarknode{B}{Transport coefficient\footnote{More on transport coefficients in QGP from {\color{jyured}Maria-Lucia} and {\color{jyured}Salvatore}} ${\color{ming}\kappa_i}=\dfrac{\mathrm{d}}{\mathrm{d}\tau}\langle \delta p^2_i(\tau)\rangle$ $\phantom{-p_i^2(\tau_\mathrm{form})abcd}$}\\[5pt]
        ...
        \begin{tikzpicture}[overlay,remember picture,
            ...
            \path[NO]   (M.north -| N.east) -- node[right=8pt] {\color{custompink}observables\symfootnote{More on HF observables from {\color{jyured} Mattia}}} (N.south east);
        \end{tikzpicture}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{columns}[onlytextwidth,t]
       ...
       \begin{figure}
            ...
            \only<5>{\includegraphics[width=0.85\textwidth]{images/beauty_early_behaviour_mom_broad.pdf}}
        \end{figure}
        \column{.02\textwidth}
        \column{.5\textwidth}
...
\begin{frame}[t]
    ...
    \begin{columns}[onlytextwidth,t]
       ...
       \begin{figure}
            \centering
            \captionsetup{justification=centering}
            \only<1>{\includegraphics[width=0.95\textwidth]{images/KappaGlasmaVsEKTvsLatticev2.pdf}}
        \end{figure}
        \column{.02\textwidth}
        \column{.5\textwidth}
        % \vspace{0.2cm}
        \begin{center}
            ...
            \only<1>{\Large\color{customblue} Transport coefficient $\kappa$ \\[5pt]
                \begin{itemize}
                \item {\normalsize\color{lightgray}Energy density $\varepsilon$ matched to glasma}
                \item {\normalsize\color{lightgray}Compare to $\kappa$ in glasma}
                \item {\normalsize\color{lightgray}Compare with equilibrium $\kappa_{\mathrm{eq}}$}
                \item {\normalsize\color{lightgray}Match for the same $m_D$, $T_{\star}$ and $\varepsilon$}
            \end{itemize}}
        \end{center}
        \column{.02\textwidth}
    \end{columns}
    \only<1>{\blfootnote{\scriptsize Boguslavski, Kurkela, Lappi, Lindenbauer, Peuron \href{https://journals.aps.org/prd/abstract/10.1103/PhysRevD.109.014025}{\color{customblue}\texttt{[Phys.Rev.D109(2024)]}}}}
\end{frame}
...
\begin{frame}[noframenumbering]
    ...
    \begin{columns}[onlytextwidth,t]
       ...
       \begin{figure}
            \centering
            \captionsetup{justification=centering}
            \only<1>{\includegraphics[width=0.95\textwidth]{images/Ai_t.pdf}}
        \end{figure}
        \column{.02\textwidth}
        \column{.5\textwidth}
        \begin{center}
                \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.6}{${\color{lightgray}\blacktriangleright}$}}}
                \only<1>{\Large\color{customblue} Drag, diffusion $A_i$, $B_{ij}$ \\[5pt]
                    \begin{itemize}
                    \item {\normalsize\color{lightgray}Contributions from $g, q, g+q$}
                    \item {\normalsize\color{lightgray}Angular dependence}
                    \item {\normalsize\color{lightgray}Rescaled coefficients, attractor behavior}
                \end{itemize}}
        \end{center}
        \column{.02\textwidth}
    \end{columns}
    \only<1>{\blfootnote{\scriptsize Du \href{https://journals.aps.org/prc/abstract/10.1103/PhysRevC.109.014901}{\color{customblue}\texttt{[Phys.Rev.C109(2024)]}}}}
\end{frame}
